document.addEventListener('DOMContentLoaded', function() {
    ...
    // Added: Handle room click to show quiz/activity form
    document.querySelectorAll('.clickable').forEach(function (roomElement) {
        roomElement.addEventListener('click', function () {
            ...
            // Set the hidden input value for roomId
            document.getElementById('quizRoomId').value = roomId; // Set the value here
        });
    });
